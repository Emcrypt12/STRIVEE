...
import { Clock, CheckCircle, AlertTriangle, Calendar, TrendingUp, Activity, Plus } from 'lucide-react';
import Chart from 'react-apexcharts';
import { ApexOptions } from 'apexcharts';
import { useTheme } from '../contexts/ThemeContext';
import DailyCheckin, { CheckinData } from '../components/DailyCheckin';
        ...
        <div className="bg-primary-50 rounded-xl p-6 border border-primary-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">Track your progress and earn points!</p>
            </div>
            <button
